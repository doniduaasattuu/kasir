        ...
        <AuthenticatedLayout>
            ...
            <div className="py-12">
                <div className="mx-auto max-w-7xl sm:px-6 lg:px-8 space-y-6">
                    ...
                    <div className="text-center shadow border border-neutral-600/40 w-[300px] mx-auto">
                        <div>Scan QR Product</div>
                                    ...
                                    <table className="table">
                                        ...
                                        <tbody>
                                            ...
                                            <tr key="change">
                                                ...
                                                <td></td>
                                                <td></td>
                                                <td className="font-semibold text-right w-40">
                                                    Change:
                                                </td>
                                                <td>{rupiah(change)}</td>
                                                <td></td>
